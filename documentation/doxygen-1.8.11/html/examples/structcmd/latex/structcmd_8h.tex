...
)~(((a)$>$(b))?(a)\+:(b))}\hypertarget{structcmd_8h_afa99ec4acc4ecb2dc3c2d05da15d0e3f}{}\label{structcmd_8h_afa99ec4acc4ecb2dc3c2d05da15d0e3f}
...
\paragraph[{\texorpdfstring{U\+I\+N\+T32}{UINT32}}]{\setlength{\rightskip}{0pt plus 5cm}typedef unsigned int {\bf U\+I\+N\+T32}}\hypertarget{structcmd_8h_ae1e6edbbc26d6fbc71a90190d0266018}{}\label{structcmd_8h_ae1e6edbbc26d6fbc71a90190d0266018}
...
\paragraph[{\texorpdfstring{close(int)}{close(int)}}]{\setlength{\rightskip}{0pt plus 5cm}int close (
\begin{DoxyParamCaption}
\item[{int}]{fd}
\end{DoxyParamCaption}
...
\paragraph[{\texorpdfstring{open(const char $\ast$, int)}{open(const char *, int)}}]{\setlength{\rightskip}{0pt plus 5cm}int open (
\begin{DoxyParamCaption}
...
\paragraph[{\texorpdfstring{read(int, char $\ast$, size\+\_\+t)}{read(int, char *, size_t)}}]{\setlength{\rightskip}{0pt plus 5cm}int read (
\begin{DoxyParamCaption}
\item[{int}]{fd, }
\item[{char $\ast$}]{buf, }
\item[{size\+\_\+t}]{count}
...
\paragraph[{\texorpdfstring{write(int, const char $\ast$, size\+\_\+t)}{write(int, const char *, size_t)}}]{\setlength{\rightskip}{0pt plus 5cm}size\+\_\+t write (
\begin{DoxyParamCaption}
\item[{int}]{fd, }
...
\paragraph[{\texorpdfstring{errno}{errno}}]{\setlength{\rightskip}{0pt plus 5cm}int errno}\hypertarget{structcmd_8h_ad65a8842cc674e3ddf69355898c0ecbf}{}\label{structcmd_8h_ad65a8842cc674e3ddf69355898c0ecbf}
